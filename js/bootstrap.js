...
function e(e, i, s) {
  ...
  s = t.extend(!0, {}, o, s), this.settings = t.extend(!0, {}, n, s), this._defaults = n, "-" === this.settings.content.target && (this.settings.content.target = this.settings.url_target), this.animations = {
      ...
      var n = !1;
      return t('[data-alret="container"]').each(function(i, s) {
          var o = t(s),
...
String.format = function() {
  ...
  init: function() {
      var t = this;
      this.buildalret(), this.settings.content.icon && this.setIcon(), "#" != this.settings.content.url && this.styleURL(), this.styleDismiss(), this.placement(), this.bind(), this.alret = {
          $ele: this.$ele,
          update: function(e, n) {
              var i = {};
              for (var s in "string" == typeof e ? i[e] = n : i = e, i) switch (s) {
                  case "type":
                      this.$ele.removeClass("alert-" + t.settings.type), this.$ele.find('[data-alret="progressbar"] > .progress-bar').removeClass("progress-bar-" + t.settings.type), t.settings.type = i[s], this.$ele.addClass("alert-" + i[s]).find('[data-alret="progressbar"] > .progress-bar').addClass("progress-bar-" + i[s]);
                      break;
                  case "icon":
                  ...
                  case "progress":
                      ...
                      this.$ele.data("alret-delay", r), this.$ele.find('[data-alret="progressbar"] > div').attr("aria-valuenow", i[s]).css("width", i[s] + "%");
                      break;
                  case "url":
                      this.$ele.find('[data-alret="url"]').attr("href", i[s]);
                      break;
                  case "target":
                      this.$ele.find('[data-alret="url"]').attr("target", i[s]);
                      break;
                  default:
                      this.$ele.find('[data-alret="' + s + '"]').html(i[s])
              }
  ...
  buildalret: function() {
      ...
      this.$ele = t(String.format(this.settings.template, this.settings.type, e.title, e.message, e.url, e.target)), this.$ele.attr("data-alret-position", this.settings.placement.from + "-" + this.settings.placement.align), this.settings.allow_dismiss || this.$ele.find('[data-alret="dismiss"]').css("display", "none"), (this.settings.delay <= 0 && !this.settings.showProgressbar || !this.settings.showProgressbar) && this.$ele.find('[data-alret="progressbar"]').remove()
  },
  setIcon: function() {
      "class" === this.settings.icon_type.toLowerCase() ? this.$ele.find('[data-alret="icon"]').addClass(this.settings.content.icon) : this.$ele.find('[data-alret="icon"]').is("img") ? this.$ele.find('[data-alret="icon"]').attr("src", this.settings.content.icon) : this.$ele.find('[data-alret="icon"]').append('<img src="' + this.settings.content.icon + '" alt="alret Icon" />')
  },
  styleDismiss: function() {
      this.$ele.find('[data-alret="dismiss"]').css({
          position: "absolute",
          right: "10px",
          top: "5px",
  ...
  styleURL: function() {
      this.$ele.find('[data-alret="url"]').css({
  ...
  placement: function() {
      var e = this,
          ...
          s = !1,
          o = this.settings;
      switch (t('[data-alret-position="' + this.settings.placement.from + "-" + this.settings.placement.align + '"]:not([data-closing="true"])').each(function() {
  ...
  bind: function() {
      var e = this;
      if (this.$ele.find('[data-alret="dismiss"]').on("click", function() {
              e.close()
          ...
          var n = setInterval(function() {
              ...
              if ("false" === e.$ele.data("data-hover") && "pause" === e.settings.mouse_over || "pause" != e.settings.mouse_over) {
                  ...
                  e.$ele.data("alret-delay", t), e.$ele.find('[data-alret="progressbar"] > div').attr("aria-valuenow", i).css("width", i + "%")
              }
...
}), t.alret = function(t, n) {
  return new e(this, t, n).alret
}, t.alretDefaults = function(e) {
  return n = t.extend(!0, {}, n, e)
}, t.alretClose = function(e) {
  "warning" === e && (e = "danger"), void 0 === e || "all" === e ? t("[data-alret]").find('[data-alret="dismiss"]').trigger("click") : "success" === e || "info" === e || "warning" === e || "danger" === e ? t(".alert-" + e + "[data-alret]").find('[data-alret="dismiss"]').trigger("click") : e ? t(e + "[data-alret]").find('[data-alret="dismiss"]').trigger("click") : t('[data-alret-position="' + e + '"]').find('[data-alret="dismiss"]').trigger("click")
}, t.alretCloseExcept = function(e) {
  "warning" === e && (e = "danger"), "success" === e || "info" === e || "warning" === e || "danger" === e ? t("[data-alret]").not(".alert-" + e).find('[data-alret="dismiss"]').trigger("click") : t("[data-alret]").not(e).find('[data-alret="dismiss"]').trigger("click")
}
})
   var $videoSrc;  
...
let colors = $(el[t]).attr("data-setcolor");

$('[data-setcolor="' + colors + '"]').css({
  background: colors
})
}
if ($(".img-cover")[0]) {
...
if ($("a.scrollLink").on('click',function(t) {
...
if (t.length > showChar) {
  var e = t.substring(0, showChar),
      n = t.substring(showChar, t.length - showChar),
...
(function ($) {
  ...
  $(".ripple-effect").on('click',function(o) {
      0 === $(this).find(".ink").length && $(this).prepend("<span class='ink'></span>"), (t = $(this).find(".ink")).removeClass("animate"), t.height() || t.width() || (n = Math.max($(this).outerWidth(), $(this).outerHeight()), t.css({
          height: n,
          width: n
      })), i = o.pageX - $(this).offset().left - t.width() / 2, s = o.pageY - $(this).offset().top - t.height() / 2, t.css({
          top: s + "px",
          left: i + "px"
      }).addClass("animate")
  })
